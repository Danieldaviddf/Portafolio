      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-[1fr_0.8fr]">
        ...
        <div className="text-center lg:text-left">
          ...
          >
            DISEÑO
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-200 via-orange-500 to-orange-800 drop-shadow-[0_0_50px_rgba(249,115,22,0.4)]">
              FUTURO
            </span>
            <br />
            EN LA WEB.
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-3 lg:justify-start">
            {SKILLS.map((skill, index) => (
              <motion.span
                ...
                className="rounded-2xl border border-white/10 bg-white/5 px-5 py-2 text-xs font-semibold text-orange-50/85 backdrop-blur transition hover:border-orange-400/60"
              >
                {skill}
              </motion.span>
            ))}
